...
public class ComprasParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ComprasGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTechnologyAccess().getGroup_2_4(), "rule__Technology__Group_2_4__0");
			...
			builder.put(grammarAccess.getTechnologyAccess().getDataFileSeedAssignment_2_4_2(), "rule__Technology__DataFileSeedAssignment_2_4_2");
