...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Controllers Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.compras.compras.impl.ControllersRefImpl#getFunctionality <em>Functionality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControllersRefImpl extends MinimalEObjectImpl.Container implements ControllersRef
{
  /**
  ...
  {
    return ComprasPackage.Literals.CONTROLLERS_REF;
  }
    ...
    if (functionality != null && functionality.eIsProxy())
    {
      ...
      if (functionality != oldFunctionality)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComprasPackage.CONTROLLERS_REF__FUNCTIONALITY, oldFunctionality, functionality));
      }
    }
  ...
  public void setFunctionality(Functionality newFunctionality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComprasPackage.CONTROLLERS_REF__FUNCTIONALITY, oldFunctionality, functionality));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComprasPackage.CONTROLLERS_REF__FUNCTIONALITY:
