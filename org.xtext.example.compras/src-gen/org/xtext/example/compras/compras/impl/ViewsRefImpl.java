...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Views Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.compras.compras.impl.ViewsRefImpl#getFunctionality <em>Functionality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewsRefImpl extends MinimalEObjectImpl.Container implements ViewsRef
{
  /**
  ...
  {
    return ComprasPackage.Literals.VIEWS_REF;
  }
    ...
    if (functionality != null && functionality.eIsProxy())
    {
      ...
      if (functionality != oldFunctionality)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComprasPackage.VIEWS_REF__FUNCTIONALITY, oldFunctionality, functionality));
      }
    }
  ...
  public void setFunctionality(Functionality newFunctionality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComprasPackage.VIEWS_REF__FUNCTIONALITY, oldFunctionality, functionality));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComprasPackage.VIEWS_REF__FUNCTIONALITY:
