...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Access Layer Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.compras.compras.impl.DataAccessLayerRefImpl#getFunctionality <em>Functionality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataAccessLayerRefImpl extends MinimalEObjectImpl.Container implements DataAccessLayerRef
{
  /**
   ...
   * @generated
   */
  protected DataAccessLayerRefImpl()
  {
    super();
  }
  ...
  {
    return ComprasPackage.Literals.DATA_ACCESS_LAYER_REF;
  }
    ...
    if (functionality != null && functionality.eIsProxy())
    {
      ...
      if (functionality != oldFunctionality)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComprasPackage.DATA_ACCESS_LAYER_REF__FUNCTIONALITY, oldFunctionality, functionality));
      }
    }
  ...
  public void setFunctionality(Functionality newFunctionality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComprasPackage.DATA_ACCESS_LAYER_REF__FUNCTIONALITY, oldFunctionality, functionality));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComprasPackage.DATA_ACCESS_LAYER_REF__FUNCTIONALITY:
