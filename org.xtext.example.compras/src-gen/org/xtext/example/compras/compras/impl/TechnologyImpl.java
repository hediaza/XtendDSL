 ...
 *   <li>{@link org.xtext.example.compras.compras.impl.TechnologyImpl#getDataFileSeed <em>Data File Seed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TechnologyImpl extends MinimalEObjectImpl.Container implements Technology
{
  ...
  /**
   * The default value of the '{@link #getDataFileSeed() <em>Data File Seed</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getDataFileSeed()
   * @generated
   * @ordered
   */
  protected static final String DATA_FILE_SEED_EDEFAULT = null;

  /**
   * The cached value of the '{@link #getDataFileSeed() <em>Data File Seed</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getDataFileSeed()
   * @generated
   * @ordered
   */
  protected String dataFileSeed = DATA_FILE_SEED_EDEFAULT;
   ...
   */
  @Override
  public void setDataFileSeed(String newDataFileSeed)
  {
    String oldDataFileSeed = dataFileSeed;
    dataFileSeed = newDataFileSeed;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComprasPackage.TECHNOLOGY__DATA_FILE_SEED, oldDataFileSeed, dataFileSeed));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ComprasPackage.TECHNOLOGY__DATA_FILE_SEED:
        return getDataFileSeed();
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ComprasPackage.TECHNOLOGY__CONNECTION_STRING:
        ...
        return;
      case ComprasPackage.TECHNOLOGY__DATA_FILE_SEED:
        setDataFileSeed((String)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      ...
      case ComprasPackage.TECHNOLOGY__CONNECTION_STRING:
        ...
        return;
      case ComprasPackage.TECHNOLOGY__DATA_FILE_SEED:
        setDataFileSeed(DATA_FILE_SEED_EDEFAULT);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case ComprasPackage.TECHNOLOGY__DATA_FILE_SEED:
        return DATA_FILE_SEED_EDEFAULT == null ? dataFileSeed != null : !DATA_FILE_SEED_EDEFAULT.equals(dataFileSeed);
    }
