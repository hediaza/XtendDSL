...
// Entry rule entryRuleDataFileSeed
entryRuleDataFileSeed returns [String current=null]:
	{ newCompositeNode(grammarAccess.getDataFileSeedRule()); }
	iv_ruleDataFileSeed=ruleDataFileSeed
	{ $current=$iv_ruleDataFileSeed.current.getText(); }
	EOF;

// Rule DataFileSeed
ruleDataFileSeed returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
